...
async def handle_session_info_event(
    ...
    *,
    ...
    """Register the real session ID from a session_info event and return updated ID pair."""
...
async def process_parsed_cli_event(
    ...
    *,
    ...
    """Apply one parsed CLI event to transcript and UI; returns updated (last_status, had_events)."""
