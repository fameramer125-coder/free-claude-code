...
# Epoch timestamp signals "no real creation date" for dynamically discovered models.
DISCOVERED_MODEL_CREATED_AT = "1970-01-01T00:00:00Z"

# Always advertised so Claude Code clients find familiar model IDs regardless of backend.
